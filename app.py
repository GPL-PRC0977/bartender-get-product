...
bq_cred = os.getenv("bq_cred")
bq_project_id = os.getenv("bq_project_id")

ep_key_table_id = os.getenv("ep_table_id")
ep_key_project_id = os.getenv("ep_project_id")
ep_key_secret_id = os.getenv("ep_secret_id")
...
def is_valid_api_key(api_key):
    ...
    api_client = bigquery.Client(
        credentials=api_key_credentials, project=ep_key_project_id)
